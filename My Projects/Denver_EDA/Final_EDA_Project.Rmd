...
1. close to the University of Denver (parents visiting their students)

2. quiet, safe and residential

3. close to Cherry Creek (luxurious commercial area of Denver)

4. Surrounded by beautiful mountains. 

5. Apartments and houses are much larger on average, which pulls the average up. 
...
Note: The model worked much better when we added more features. The full GAM had an R-squared of 0.58, which means the model explains about 58% of the differences in prices. However, the location-only model had only 0.07, which means that it explains only 8% of the variation (see Appendix for details).
